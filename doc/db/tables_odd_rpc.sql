#
# ODD-RPC 1.7.1-SNAPSHOT
# Copyright (c) 2015-present, oddityyyy.

CREATE database if NOT EXISTS `odd_rpc` default character set utf8mb4 collate utf8mb4_unicode_ci;
use `odd_rpc`;

SET NAMES utf8mb4;

CREATE TABLE `odd_rpc_registry` (
...
CREATE TABLE `odd_rpc_registry_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `env` varchar(50) NOT NULL COMMENT '环境标识',
  `key` varchar(255) NOT NULL COMMENT '注册Key',
...
CREATE TABLE `odd_rpc_registry_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
